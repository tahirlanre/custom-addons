...
openerp.pos_seorera = function(instance){
    ...
    module.PosModel = module.PosModel.extend({
	     load_server_data: function(){
	         ...
	         loaded = loaded.then(function(){
	              return self.fetch(
	                    'res.company',
	                    ['currency_id', 'email', 'website', 'company_registry', 'vat', 'name', 'phone', 'partner_id' , 'country_id', 'tax_calculation_rounding_method','logo', 'street', 'street2'],
	                    []
	                );
